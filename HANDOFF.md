...
Generated by `python3 scripts/genkeys.py generate`

| Role | Address | Private Key |
|------|---------|-------------|
| **Buyer** | `kaspa:qdyzkrhd74v6cetrv4fhv` | `6920e7eb4149fe3f3442e49dc523917e9401d738cb8a0f31deab6ad5bd902ca2` |
| **Seller** | `kaspa:qg3h9mhu78cw89qyc0e42` | `78f714260cb641d4e111aa4311a8ac2dccc9f7ba869e1d32e68a089fec3e0ed9` |

Both are saved in `.env.testwallets` (gitignored). The mock verifier accepts any hex string as a signature — you can just type `abcd`.
