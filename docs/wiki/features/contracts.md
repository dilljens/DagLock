...
**Source**: `contracts/src/`  **Updated**: `2026-06-09`  (8 files)
...
### Current Template Hashes (June 9, 2026)
...
| Vault (standard) | `d773d10a9a2626986226e4eca528e0cb071b79be` |
| Vault Softlock | `dd2d3699db1332bb21fcc31ef3971963e8735b16` |
| Vault Multisig | (run print_template_hashes to get current) |
