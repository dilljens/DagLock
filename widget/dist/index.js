...
class DaglockEscrowElement extends HTMLElement {
    ...
    get amount() { return this.getAttribute("amount") || "0"; }
    get asset() { return this.getAttribute("asset") || "KAS"; }
    get buyerAddress() { return this.getAttribute("buyer-address") || ""; }
    get sellerAddress() { return this.getAttribute("seller-address") || ""; }
    async handleCreate() {
        ...
        if (statusEl)
            statusEl.textContent = "Creating escrow...";
        if (errorEl)
            errorEl.textContent = "";
        try {
            const sompi = Math.round(parseFloat(this.amount) * 100000000);
            const body = {
            ...
            if (this.sellerAddress)
                Object.assign(body, { seller_address: this.sellerAddress });
            ...
            if (statusEl)
                statusEl.textContent = "Escrow created! ID: " + escrow.id;
